...
import { Drag, getImageWH } from '@h5/page/create/utils/_index'
import { savePageTpl, getPageTpl, uploadBase64Img } from '@h5/ajax'
import { Point } from '@h5/page/create/components/_index'
import { Tools } from '../_index'
import { ALLOW_ADD_POINT, initEvent } from './_event_handle'
import { POINT_SIZE, PAGE_SIZE, PRE_PAGE_ID, PRE_POINT_CLASS, PRE_PAGE_CLASS, PAGE_CONTENT_TYPE } from '@h5/config'
