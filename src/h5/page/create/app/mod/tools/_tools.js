...
import { SliderItem, ColorItem } from '@h5/page/create/components/_index'

import { POINT, TOOLS_TABS, PRE_PAGE_ID, PRE_POINT_CLASS, EVENT_NAMES, getFormatConfigByType } from '@h5/config'
import { DrawCustomArea } from '@h5/page/create/utils/draw/_index'
